...
A PDF build of the current version of the styleguide is
https://github.com/fsundermeyer/doc-styleguide/raw/master/prebuilt/current/styleguide_2014-02.2-with_changelog.pdf[available for download].  
